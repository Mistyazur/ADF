/****************************************************************************
**
** Namespace Dm generated by dumpcpp from type library
** dm.dll
**
****************************************************************************/
...
struct QMetaTypeFunctionHelper<Dm::dmsoft, /* Accepted */ true> {
    static void Delete(void *t) { delete static_cast<Dm::dmsoft*>(t); }
...
struct QMetaTypeFunctionHelper<Dm::Idmsoft, /* Accepted */ true> {
    static void Delete(void *t) { delete static_cast<Dm::Idmsoft*>(t); }
    static void *Create(const void *t)
    {
        Q_ASSERT(!t);
        Q_UNUSED(t)
        return new Dm::Idmsoft();
    }
    static void Destruct(void *t)
    {
        Q_UNUSED(t)
